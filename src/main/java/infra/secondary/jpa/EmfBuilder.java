...
public class EmfBuilder {
    ...
    public EmfBuilder() {
        config = new PersistenceConfiguration("cinemaConfig")
                ...
                .managedClass(DirectorEntity.class)
                .managedClass(LoginAuditEntity.class)
                .managedClass(MovieEntity.class)
                .managedClass(SaleEntity.class)
                .managedClass(ShowSeatEntity.class)
                .managedClass(ShowTimeEntity.class)
                .managedClass(UserEntity.class)
                .managedClass(TheaterEntity.class)
                .managedClass(UserRateEntity.class)
